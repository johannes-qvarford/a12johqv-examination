namespace a12johqv.Examination.Study
{
    ...
    public static class StudyReportPgnDatabaseCreation
    {
        public static Pgn.Database CreateDatabase(StudyReport gameReport)
        {
        ...
        private static Pgn.Game CreateGame(StudyReport studyReport)
        {
            return new Pgn.Game
                           {
                               ...
                               Result = ConvertChessToPgnResult(studyReport.GameReport.Result),
                               WhitePlayer = studyReport.WhitePlayerName,
                               BlackPlayer = studyReport.BlackPlayerName,
                               MoveText = CreateMoveText(studyReport.GameReport.Moves)
                           };
        }
