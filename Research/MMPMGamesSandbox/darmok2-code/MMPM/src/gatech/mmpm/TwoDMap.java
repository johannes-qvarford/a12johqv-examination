...
public class TwoDMap extends Map {
	...
	public void setCellLocation(PhysicalEntity pe, float coords[])
	{
		int cellCoords[] = toCellCoords(coords);
		setCellLocation(pe, cellCoords);
	}


        public void setCellLocation(PhysicalEntity pe, int cellCoords[])
        {
                map[cellCoords[0]][cellCoords[1]] = pe;
	}


        public void setCellLocation(PhysicalEntity pe, int x, int y)
        {
                map[x][y] = pe;
	}
