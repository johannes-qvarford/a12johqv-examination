...
public class ThreadedMEExecutor extends LazyMEExecutor {
    ...
    /*
     * public void getActions(GameState gs, List<Action> la) { if (canThink())
     * privateThink(gs, actions); }
     *
     * public void getActions(IGameStateProvider gameStateProvider,
     * java.util.List<plans.Action> actions) { if (canThink())
