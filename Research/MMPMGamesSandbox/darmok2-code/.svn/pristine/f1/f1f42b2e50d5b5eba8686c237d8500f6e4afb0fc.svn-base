...
public class GraphMap extends Map {
	...
	public void setCellLocation(PhysicalEntity mapEntity, float coords[])
	{
            GraphMapNode n = closestNode(coords);
            if(mapEntity != null) mapEntity.set_Coords(n.coords);
            n.m_entity = mapEntity;
	}


        public void setCellLocation(PhysicalEntity mapEntity, int cellCoords[])
        {
