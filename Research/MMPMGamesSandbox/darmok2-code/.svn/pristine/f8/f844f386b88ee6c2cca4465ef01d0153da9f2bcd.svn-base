...
public class DummyTransition extends Transition {
     ...
     *
     */
    private static final long serialVersionUID = -2957128248115286128L;

    public DummyTransition() {
        super();
        setElementID("DUMMYTRAN" + getElementID());
    }
    ...
    public void writeToXML(String planID, XMLWriter w) {
        w.rawXML("<transition id='" + this.getElementID() + "' type=\"DummyTransition\">");
        w.tag("conditions");
    ...
    public Object clone(HashMap<Object, Object> alreadyCloned) {
        ...
        DummyTransition cloneT = new DummyTransition();
