...
public class AssocRuleMining {
	...
	protected int numOneItemSets = 0; //The number of singletons

	protected BufferedReader fileInput; //The input stream

	protected File filePath = null;	//The file path
...
//	}
	...
	protected short[] realloc1(short[] oldItemSet, short newElement) {
		...
		// Otherwise create new item set with length one greater than old item set
		int oldItemSetLength = oldItemSet.length;
		short[] newItemSet = new short[oldItemSetLength+1];
