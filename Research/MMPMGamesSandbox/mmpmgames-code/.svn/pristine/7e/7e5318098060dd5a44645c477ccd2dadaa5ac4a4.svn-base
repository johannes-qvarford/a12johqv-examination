...
public abstract class S2Entity 
{

	public int entityID;
	public String owner;
	
	public S2Entity(int iEntityID, String iOwner)
	{
		entityID = iEntityID;
		owner = iOwner;
	}
	...
	public S2Entity( S2Entity incoming)
	{
	...
	public boolean greater(S2Entity incoming)
	{
	...
	public boolean lesser(S2Entity incoming)
	{
		boolean returnFlag = true;
		//System.out.println(this.getClass());
		//System.out.println(incoming.getClass());
	...
	public boolean equals(S2Entity incoming)
	{
		boolean returnFlag = true;
		//System.out.println(this.getClass());
		//System.out.println(incoming.getClass());
...
//						System.out.println("found feature '" + m.getName().substring(3) + "' for " + c_name);
	...
	public boolean equivalents(S2Entity e) {
