...
public class HaveWBarracks extends Sensor {
	 ...
	 */
	static Sensor _backend = new Invocation(new HaveUnit(), new Pair<String, Sensor>("type", new Invocation(new Type(), new Pair<String, Sensor>("type", new ConstantString("s2.mmpm.entities.WBarracks")))));
