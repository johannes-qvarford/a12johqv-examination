...
/**
 * @author Santi: AI that builds a barracks, blacksmith and lumbermill, two
 * peasants harvesting gold, and two harvesting wood, then builds catapults
 * without stop and attacks! After a while, increases the number of peasants to
 * 3 and 3, and builds a second barracks. It also looks for goldmines where
 * there is still available gold Also, it sends catapults in waves
 */
public class CatapultRush2 extends FootmenRush2 {

    public CatapultRush2(String playerID) {
        super(playerID);
