...
import gatech.mmpm.learningengine.LazyMEExecutor;
import gatech.mmpm.learningengine.ThreadedMEExecutor;
...
//			return null;
    ...
    public D2 getD2() {
        if (m_d2AI instanceof LazyMEExecutor) {
            return (D2) (((ThreadedMEExecutor)m_d2AI).getOriginal());
        } else if (m_d2AI instanceof D2) {
            return (D2)m_d2AI;
        } else {
            return null;
        }
