 ...
 */
public class NextMoveDelay extends Sensor {

	public NextMoveDelay() {
	} // Constructor

	//---------------------------------------------------------------

	public NextMoveDelay(NextMoveDelay rhs) {
	...
	public Object clone() {
		...
		NextMoveDelay e = new NextMoveDelay(this);
		return e;
	 ...
	 */
	static Sensor _backend = new Invocation(new IntAttribute(), new Pair<String, Sensor>("entity", new Invocation(new Entity(), new Pair<String, Sensor>("type", new Invocation(new Type(), new Pair<String, Sensor>("type", new ConstantString("bc.mmpm.entities.BCOPlayerTank")))), new Pair<String, Sensor>("owner", new GetContextValue("player", ActionParameterType.PLAYER)), new Pair<String, Sensor>("entityid", null))), new Pair<String, Sensor>("attribute", new ConstantString("next_move_delay")));
