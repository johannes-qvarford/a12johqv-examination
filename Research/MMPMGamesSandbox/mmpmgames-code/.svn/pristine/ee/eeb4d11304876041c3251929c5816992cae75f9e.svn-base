 ...
 */
public class EnemyBaseInLine extends Sensor {

	public EnemyBaseInLine() {
	} // Constructor

	//---------------------------------------------------------------

	public EnemyBaseInLine(EnemyBaseInLine rhs) {
	...
	public Object clone() {
		...
		EnemyBaseInLine e = new EnemyBaseInLine(this);
		return e;
