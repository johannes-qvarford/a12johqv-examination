...
import gatech.mmpm.sensor.builtin.IsCellEmpty;
 ...
 */
public class BuildableCoordinates extends Sensor {

	public BuildableCoordinates() {
	} // Constructor

	//---------------------------------------------------------------

	public BuildableCoordinates(BuildableCoordinates rhs) {
	...
	public Object clone() {
		...
		BuildableCoordinates e = new BuildableCoordinates(this);
		return e;
	 ...
	 */
	static Sensor _backend = new AndCondition(new Invocation(new IsCellEmpty(), new Pair<String, Sensor>("coor", new GetContextValue("coor", ActionParameterType.COORDINATE))), new OrCondition(new RelationalCondition(new Invocation(new DistanceEC(), new Pair<String, Sensor>("entity", new Invocation(new ClosestEntity(), new Pair<String, Sensor>("coor", new GetContextValue("coor", ActionParameterType.COORDINATE)), new Pair<String, Sensor>("type", new Invocation(new Type(), new Pair<String, Sensor>("type", new ConstantString("towers.mmpm.entities.TTower")))), new Pair<String, Sensor>("owner", new GetContextValue("player", ActionParameterType.PLAYER)))), new Pair<String, Sensor>("coor", new GetContextValue("coor", ActionParameterType.COORDINATE))), RelationalCondition.Operator.LESS_EQUAL_THAN, new ConstantFloat(80.0)), new RelationalCondition(new Invocation(new DistanceEC(), new Pair<String, Sensor>("entity", new Invocation(new ClosestEntity(), new Pair<String, Sensor>("coor", new GetContextValue("coor", ActionParameterType.COORDINATE)), new Pair<String, Sensor>("type", new Invocation(new Type(), new Pair<String, Sensor>("type", new ConstantString("towers.mmpm.entities.TBase")))), new Pair<String, Sensor>("owner", new GetContextValue("player", ActionParameterType.PLAYER)))), new Pair<String, Sensor>("coor", new GetContextValue("coor", ActionParameterType.COORDINATE))), RelationalCondition.Operator.LESS_EQUAL_THAN, new ConstantFloat(80.0))));
