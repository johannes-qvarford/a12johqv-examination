...
import gatech.mmpm.sensor.builtin.HasAttribute;
 ...
 */
public class ChangedEntity extends Sensor {
	...
	public ChangedEntity(ChangedEntity rhs) {
	...
	public Object clone() {
		...
		ChangedEntity e = new ChangedEntity(this);
		return e;
	 ...
	 */
	static Sensor _backend = new Invocation(new HasAttribute(), new Pair<String, Sensor>("entity", new GetContextValue("entity", ActionParameterType.ENTITY_ID)), new Pair<String, Sensor>("attribute", new GetContextValue("newAttribute", ActionParameterType.STRING)));
	...
	static {
		...
		_listOfNeededParameters.add(new Pair<String,ActionParameterType>("newAttribute", ActionParameterType.STRING));
