...
import bc.mmpm.sensors.ClosestEntityInLine;
 ...
 */
public class GetInLineWithEnemyBase extends Sensor {

	public GetInLineWithEnemyBase() {
	} // Constructor

	//---------------------------------------------------------------

	public GetInLineWithEnemyBase(GetInLineWithEnemyBase rhs) {
	...
	public Object clone() {
		...
		GetInLineWithEnemyBase e = new GetInLineWithEnemyBase(this);
		return e;
	 ...
	 */
	static Sensor _backend = new AndCondition(new EqualitySensor(new ConstantString("BCOBase"), EqualitySensor.Operator.EQUAL_THAN, new Invocation(new StringAttribute(), new Pair<String, Sensor>("entity", new Invocation(new ClosestEntityInLine())), new Pair<String, Sensor>("attribute", new ConstantString("type")))), new EqualitySensor(new GetContextValue("player", ActionParameterType.PLAYER), EqualitySensor.Operator.NOT_EQUAL_THAN, new Invocation(new StringAttribute(), new Pair<String, Sensor>("entity", new Invocation(new ClosestEntityInLine())), new Pair<String, Sensor>("attribute", new ConstantString("owner")))));
