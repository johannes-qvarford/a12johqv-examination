 ...
 */
public class TUpgradeGold extends gatech.mmpm.PhysicalEntity {

	public TUpgradeGold(String entityID, String owner) {
	...
	public TUpgradeGold(TUpgradeGold rhs) {
	...
	public Object clone() {
		...
		TUpgradeGold e = new TUpgradeGold(this);
		return e;
