...
public class EntitiesNeededToBuildType extends Sensor {
	 ...
	 */
	static Sensor _backend = new Conditional(new EqualitySensor(new Invocation(new Type(), new Pair<String, Sensor>("type", new ConstantString("s2.mmpm.entities.WPeasant"))), EqualitySensor.Operator.EQUAL_THAN, new GetContextValue("type", ActionParameterType.ENTITY_TYPE)), new Invocation(new EntityTypeExists(), new Pair<String, Sensor>("type", new Invocation(new Type(), new Pair<String, Sensor>("type", new ConstantString("s2.mmpm.entities.WTownhall")))), new Pair<String, Sensor>("owner", new GetContextValue("player", ActionParameterType.PLAYER))), new Conditional(new EqualitySensor(new Invocation(new Type(), new Pair<String, Sensor>("type", new ConstantString("s2.mmpm.entities.WFootman"))), EqualitySensor.Operator.EQUAL_THAN, new GetContextValue("type", ActionParameterType.ENTITY_TYPE)), new Invocation(new EntityTypeExists(), new Pair<String, Sensor>("type", new Invocation(new Type(), new Pair<String, Sensor>("type", new ConstantString("s2.mmpm.entities.WBarracks")))), new Pair<String, Sensor>("owner", new GetContextValue("player", ActionParameterType.PLAYER))), new Conditional(new EqualitySensor(new Invocation(new Type(), new Pair<String, Sensor>("type", new ConstantString("s2.mmpm.entities.WArcher"))), EqualitySensor.Operator.EQUAL_THAN, new GetContextValue("type", ActionParameterType.ENTITY_TYPE)), new AndCondition(new Invocation(new EntityTypeExists(), new Pair<String, Sensor>("type", new Invocation(new Type(), new Pair<String, Sensor>("type", new ConstantString("s2.mmpm.entities.WBarracks")))), new Pair<String, Sensor>("owner", new GetContextValue("player", ActionParameterType.PLAYER))), new Invocation(new EntityTypeExists(), new Pair<String, Sensor>("type", new Invocation(new Type(), new Pair<String, Sensor>("type", new ConstantString("s2.mmpm.entities.WLumberMill")))), new Pair<String, Sensor>("owner", new GetContextValue("player", ActionParameterType.PLAYER)))), new AndCondition(new AndCondition(new Invocation(new EntityTypeExists(), new Pair<String, Sensor>("type", new Invocation(new Type(), new Pair<String, Sensor>("type", new ConstantString("s2.mmpm.entities.WBarracks")))), new Pair<String, Sensor>("owner", new GetContextValue("player", ActionParameterType.PLAYER))), new Invocation(new EntityTypeExists(), new Pair<String, Sensor>("type", new Invocation(new Type(), new Pair<String, Sensor>("type", new ConstantString("s2.mmpm.entities.WLumberMill")))), new Pair<String, Sensor>("owner", new GetContextValue("player", ActionParameterType.PLAYER)))), new Invocation(new EntityTypeExists(), new Pair<String, Sensor>("type", new Invocation(new Type(), new Pair<String, Sensor>("type", new ConstantString("s2.mmpm.entities.WBlacksmith")))), new Pair<String, Sensor>("owner", new GetContextValue("player", ActionParameterType.PLAYER)))))));
