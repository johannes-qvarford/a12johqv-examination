 ...
 */
public class DisappearedEntity extends Sensor {

	public DisappearedEntity() {
	} // Constructor

	//---------------------------------------------------------------

	public DisappearedEntity(DisappearedEntity rhs) {
	...
	public Object clone() {
		...
		DisappearedEntity e = new DisappearedEntity(this);
		return e;
	 ...
	 */
	static Sensor _backend = new EqualitySensor(new Invocation(new EntityExists(), new Pair<String, Sensor>("entity", new GetContextValue("entity", ActionParameterType.ENTITY_ID))), EqualitySensor.Operator.EQUAL_THAN, new False());
