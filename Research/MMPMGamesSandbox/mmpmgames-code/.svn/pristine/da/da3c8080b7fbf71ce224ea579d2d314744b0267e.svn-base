 ...
 */
public class TUpgradeUnits extends gatech.mmpm.PhysicalEntity {

	public TUpgradeUnits(String entityID, String owner) {
	...
	public TUpgradeUnits(TUpgradeUnits rhs) {
	...
	public Object clone() {
		...
		TUpgradeUnits e = new TUpgradeUnits(this);
		return e;
