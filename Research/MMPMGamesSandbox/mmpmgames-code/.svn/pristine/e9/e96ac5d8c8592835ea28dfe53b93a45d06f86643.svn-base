...
/**
 * Main class of the "towerreloaded" application. It just
 * contains the main method that launch all the application.
 * 
...
public class Main {
	...
	public static void printUsage() {
		System.out.println("Towers: play towers according to the config file.");
		System.out.println();
		System.out.println("Usage: towers -m map -i interval [-t method] [-u user] [-p playerType|idname|AIType|ME]...");
		System.out.println();
		...
		System.out.println("  towers -t file:trace.xml config.xml -p 0|Peter|ia-random -m ./map1.xml -i 50");
		System.out.println("     Launches Towers and save the traces to trace.xml");
		System.out.println();
		System.out.println("  towers -t file config.xml [...]");
		System.out.println("     Launches Towers and save the trace to a file whose name");
		System.out.println("     is chosen based on the current time.");
		System.out.println();
		System.out.println("  towers -t remote:towersportal.com:8888 config.xml [...]");
		System.out.println("     Launches Towers and send the trace to the server towarsportal.com");
	}
	...
	public static String internalMain(String args[],int maxCycles) {
        ...
        try {
            TowersApp app = new TowersApp(map, traceInterval, players, tracerUsed, false);
            if (userName != null)
