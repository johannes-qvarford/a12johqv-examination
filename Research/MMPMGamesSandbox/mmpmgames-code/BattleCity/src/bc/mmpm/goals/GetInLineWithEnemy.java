 ...
 */
public class GetInLineWithEnemy extends Sensor {

	public GetInLineWithEnemy() {
	} // Constructor

	//---------------------------------------------------------------

	public GetInLineWithEnemy(GetInLineWithEnemy rhs) {
	...
	public Object clone() {
		...
		GetInLineWithEnemy e = new GetInLineWithEnemy(this);
		return e;
	 ...
	 */
	static Sensor _backend = new AndCondition(new EqualitySensor(new ConstantString("BCOPlayerTank"), EqualitySensor.Operator.EQUAL_THAN, new Invocation(new StringAttribute(), new Pair<String, Sensor>("entity", new Invocation(new ClosestEntityInLine())), new Pair<String, Sensor>("attribute", new ConstantString("type")))), new EqualitySensor(new GetContextValue("player", ActionParameterType.PLAYER), EqualitySensor.Operator.NOT_EQUAL_THAN, new Invocation(new StringAttribute(), new Pair<String, Sensor>("entity", new Invocation(new ClosestEntityInLine())), new Pair<String, Sensor>("attribute", new ConstantString("owner")))));
