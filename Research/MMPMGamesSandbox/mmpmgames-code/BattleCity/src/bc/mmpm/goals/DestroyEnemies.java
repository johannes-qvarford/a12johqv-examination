 ...
 */
public class DestroyEnemies extends Sensor {
	...
	public DestroyEnemies(DestroyEnemies rhs) {
	...
	public Object clone() {
		...
		DestroyEnemies e = new DestroyEnemies(this);
		return e;
	 ...
	 */
	static Sensor _backend = new EqualitySensor(new Invocation(new NumberOfEntities(), new Pair<String, Sensor>("type", new Invocation(new Type(), new Pair<String, Sensor>("type", new ConstantString("bc.mmpm.entities.BCOPlayerTank")))), new Pair<String, Sensor>("owner", new GetContextValue("player", ActionParameterType.PLAYER))), EqualitySensor.Operator.EQUAL_THAN, new Invocation(new NumberOfEntities(), new Pair<String, Sensor>("type", new Invocation(new Type(), new Pair<String, Sensor>("type", new ConstantString("bc.mmpm.entities.BCOPlayerTank")))), new Pair<String, Sensor>("owner", null)));
