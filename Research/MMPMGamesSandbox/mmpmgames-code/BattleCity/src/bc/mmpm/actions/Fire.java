...
import bc.mmpm.sensors.NextShotDelay;
 ...
 */
public class Fire extends gatech.mmpm.Action {
	 ...
	 * the action.
	 */
	public Fire(String entityID, String playerID) {
	 ...
	 * pattern.
	 */
	static protected Sensor _preCondition = new EqualitySensor(new Invocation(new NextShotDelay()), EqualitySensor.Operator.EQUAL_THAN, new ConstantInteger(0));
