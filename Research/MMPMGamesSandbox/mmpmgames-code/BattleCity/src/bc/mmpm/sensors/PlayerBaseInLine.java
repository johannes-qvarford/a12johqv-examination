 ...
 */
public class PlayerBaseInLine extends Sensor {

	public PlayerBaseInLine() {
	} // Constructor

	//---------------------------------------------------------------

	public PlayerBaseInLine(PlayerBaseInLine rhs) {
	...
	public Object clone() {
		...
		PlayerBaseInLine e = new PlayerBaseInLine(this);
		return e;
