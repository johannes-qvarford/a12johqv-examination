 ...
 */
public class WallAhead extends Sensor {
	...
	public WallAhead(WallAhead rhs) {
	...
	public Object clone() {
		...
		WallAhead e = new WallAhead(this);
		return e;
	 ...
	 */
	static Sensor _backend = new EqualitySensor(new ConstantString("BCOWall"), EqualitySensor.Operator.EQUAL_THAN, new Invocation(new StringAttribute(), new Pair<String, Sensor>("entity", new Invocation(new ClosestEntityInLine())), new Pair<String, Sensor>("attribute", new ConstantString("type"))));
