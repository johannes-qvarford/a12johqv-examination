 ...
 */
public class NextShotDelay extends Sensor {

	public NextShotDelay() {
	} // Constructor

	//---------------------------------------------------------------

	public NextShotDelay(NextShotDelay rhs) {
	...
	public Object clone() {
		...
		NextShotDelay e = new NextShotDelay(this);
		return e;
