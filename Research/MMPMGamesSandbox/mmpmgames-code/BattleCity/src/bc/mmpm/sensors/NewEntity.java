 ...
 */
public class NewEntity extends Sensor {
	...
	public NewEntity(NewEntity rhs) {
	...
	public Object clone() {
		...
		NewEntity e = new NewEntity(this);
		return e;
	 ...
	 */
	static Sensor _backend = new Invocation(new EntityExists(), new Pair<String, Sensor>("entity", new GetContextValue("entity", ActionParameterType.ENTITY_ID)));
