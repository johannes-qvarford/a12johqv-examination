 ...
 */
public class BlockAhead extends Sensor {
	...
	public BlockAhead(BlockAhead rhs) {
	...
	public Object clone() {
		...
		BlockAhead e = new BlockAhead(this);
		return e;
	 ...
	 */
	static Sensor _backend = new EqualitySensor(new ConstantString("BCOBlock"), EqualitySensor.Operator.EQUAL_THAN, new Invocation(new StringAttribute(), new Pair<String, Sensor>("entity", new Invocation(new ClosestEntityInLine())), new Pair<String, Sensor>("attribute", new ConstantString("type"))));
