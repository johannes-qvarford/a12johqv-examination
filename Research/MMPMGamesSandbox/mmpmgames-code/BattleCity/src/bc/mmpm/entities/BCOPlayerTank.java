...
import bc.mmpm.actions.Fire;
import bc.mmpm.actions.Move;
...
public class BCOPlayerTank extends BCOTank {
	...
	public BCOPlayerTank(String entityID, String owner) {
	...
	public BCOPlayerTank(BCOPlayerTank rhs) {
	...
	static {
		...
		_listOfFeatures = new java.util.LinkedList<String>(BCOTank.staticListOfFeatures());

		// Add valid actions to _listOfActions.
		_listOfActions = new java.util.LinkedList<Action>(BCOTank.staticListOfActions());
		Action a;
		a = new Fire(null, null);
		_listOfActions.add(a);

		a = new Move(null, null);
		a.setParameterValue("direction", "0");
		_listOfActions.add(a);

		a = new Move(null, null);
		a.setParameterValue("direction", "1");
		_listOfActions.add(a);

		a = new Move(null, null);
		a.setParameterValue("direction", "2");
		_listOfActions.add(a);

		a = new Move(null, null);
		a.setParameterValue("direction", "3");
		_listOfActions.add(a);
