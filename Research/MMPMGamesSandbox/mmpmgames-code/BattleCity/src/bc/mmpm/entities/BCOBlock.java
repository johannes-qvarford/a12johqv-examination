...
public class BCOBlock extends BCOBoundaryUnit {
	...
	public BCOBlock(String entityID, String owner) {
	
		super(entityID, owner);
		_canBeDestroyedFlag = true;
		
	} // Constructor

	//---------------------------------------------------------------

	public BCOBlock(BCOBlock rhs) {
	...
	static {
		...
		_listOfFeatures = new java.util.LinkedList<String>(BCOBoundaryUnit.staticListOfFeatures());

		// Add valid actions to _listOfActions.
		_listOfActions = new java.util.LinkedList<Action>(BCOBoundaryUnit.staticListOfActions());
