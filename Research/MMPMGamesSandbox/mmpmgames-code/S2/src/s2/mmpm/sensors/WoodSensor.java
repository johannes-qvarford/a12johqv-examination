...
public class WoodSensor extends Sensor {
	 ...
	 */
	static Sensor _backend = new Invocation(new IntAttribute(), new Pair<String, Sensor>("entity", new Invocation(new Entity(), new Pair<String, Sensor>("type", new Invocation(new Type(), new Pair<String, Sensor>("type", new ConstantString("s2.mmpm.entities.WPlayer")))), new Pair<String, Sensor>("owner", new GetContextValue("player", ActionParameterType.PLAYER)), new Pair<String, Sensor>("entityid", null))), new Pair<String, Sensor>("attribute", new ConstantString("wood")));
