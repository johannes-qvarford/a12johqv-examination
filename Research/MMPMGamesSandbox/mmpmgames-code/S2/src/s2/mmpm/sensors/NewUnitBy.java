...
public class NewUnitBy extends Sensor {
	...
	public Object evaluate(int cycle, GameState gs, String player, Context parameters) {
		...
		for(gatech.mmpm.Entity e:gs.getAllEntities()) {
			    if (e instanceof s2.mmpm.entities.WUnit) {
				    s2.mmpm.entities.WUnit u = (s2.mmpm.entities.WUnit)e;
				    if (u.getClass().equals(getTypeParam(parameters,"type")) &&
				      	u.getCreator().equals(getEntityParam(parameters,"id").getentityID()) &&
