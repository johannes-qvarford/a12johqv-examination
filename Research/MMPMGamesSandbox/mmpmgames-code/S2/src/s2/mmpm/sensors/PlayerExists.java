...
public class PlayerExists extends Sensor {
	 ...
	 */
	static Sensor _backend = new Invocation(new EntityTypeExists(), new Pair<String, Sensor>("type", new Invocation(new Type(), new Pair<String, Sensor>("type", new ConstantString("s2.mmpm.entities.WPlayer")))), new Pair<String, Sensor>("owner", new GetContextValue("owner", ActionParameterType.PLAYER)));
