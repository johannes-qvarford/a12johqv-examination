 ...
 */
public class Gold extends Sensor {
	 ...
	 */
	static Sensor _backend = new Invocation(new IntAttribute(), new Pair<String, Sensor>("entity", new Invocation(new Entity(), new Pair<String, Sensor>("type", new Invocation(new Type(), new Pair<String, Sensor>("type", new ConstantString("towers.mmpm.entities.TPlayer")))), new Pair<String, Sensor>("owner", new GetContextValue("player", ActionParameterType.PLAYER)), new Pair<String, Sensor>("entityid", null))), new Pair<String, Sensor>("attribute", new ConstantString("gold")));
