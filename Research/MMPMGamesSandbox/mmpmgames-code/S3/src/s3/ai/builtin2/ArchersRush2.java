...
/**
 * @author Santi: AI that builds a barracks and lumbermill, two peasants
 * harvesting gold, and two harvesting wood, then builds archers without stop
 * and attacks! After a while, increases the number of peasants to 3 and 3, and
 * builds a second barracks. It also looks for goldmines where there is still
 * available gold Also, it sends archers in waves
 */
public class ArchersRush2 extends FootmenRush2 {

    public ArchersRush2(String playerID) {
        super(playerID);
    ...
    List<Request> checkBarracks(S3 game, WPlayer player) {
        ...
        if (DEBUG >= 1) {
            System.out.println("ArchersRush: checkBarracks");
        }
