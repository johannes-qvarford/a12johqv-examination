...
/**
 * @author Santi: AI that builds the necessary to train knights, two peasants
 * harvesting gold, and two harvesting wood, then builds knights without stop
 ...
 * available gold Also, it sends knights in waves
 */
public class KnightsRush2 extends FootmenRush2 {

    public KnightsRush2(String playerID) {
        super(playerID);
