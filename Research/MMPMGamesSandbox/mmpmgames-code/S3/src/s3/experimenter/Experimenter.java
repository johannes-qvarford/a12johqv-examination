...
public class Experimenter {
    ...
    static final int EXPERIMENT_DEBUG = 0; // Just a simple run of map 0 with
    // trace 0
    static final int EXPERIMENT_MAP_TRACE_TABLE = 1; // systematically try each
    // trace with each map
    // (D2 learns from a
    // single trace each
    // time)
    static final int EXPERIMENT_LEARNING_CURVE = 2; // Learning curve of
    // learning from 1 trace, 2
    // traces, 3 traces, and all
    // the way to 10 traces
    ...
    public static void main(String args[]) {
        ...
        String outputFolder = "D2Experimenter/results/S3--" + repetitions;
